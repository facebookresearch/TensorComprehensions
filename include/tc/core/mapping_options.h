...
class MappingOptions : public MappingOptionsView {
 public:
  MappingOptions() : MappingOptionsView(ownedProto_) {}
  MappingOptions(const MappingOptions& options)
      : MappingOptionsView(ownedProto_), ownedProto_(options.proto) {}
  explicit MappingOptions(const MappingOptionsProto& proto)
      : MappingOptionsView(ownedProto_), ownedProto_(proto) {}
  explicit MappingOptions(const MappingOptionsView& view)
      : MappingOptionsView(ownedProto_), ownedProto_(view.proto) {}
