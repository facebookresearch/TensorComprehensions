...
module avail
module load cuda/8.0 cudnn/v6.0  mkl/2018.0.128 cmake/3.8.2/gcc.4.8.4
...
export CUDNN_ROOT_DIR=/public/apps/cudnn/v6.0/cuda/
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/public/apps/cuda/8.0/lib64/:/public/apps/cudnn/v6.0/cuda/lib64
