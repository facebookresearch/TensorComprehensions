...
[{
    ...
    'p4':hp.choice('a_p4', cat_val[4]),
    'p5':hp.choice('a_p5', cat_val[5]),
    'p6':hp.choice('a_p6', cat_val[6]),
    'p7':hp.choice('a_p7', cat_val[7]),
    'p8':hp.choice('a_p8', cat_val[8]),
    'p9':hp.choice('a_p9', cat_val[9]),
