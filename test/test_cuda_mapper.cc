...
auto reductionTestMappingOptions =
    PolyhedralMapperTest::DefaultOptions()
 ...
 */
TEST_F(PolyhedralMapperTest, ReductionBeforeInstruction) {
  string tc = R"TC(
 ...
 */
TEST_F(PolyhedralMapperTest, DISABLED_ReductionAfterInstruction) {
  string tc = R"TC(
 ...
 */
TEST_F(PolyhedralMapperTest, DISABLED_ReductionBetweenInstructions) {
  string tc = R"TC(
def fun(float(N, K) I, float(N) O0) -> (O) {
    O(n) = 0.0 where n in 0:N
    O(n) += O0(n)
